...
#figure(
  table(
    ...
    align: center,
    [*樣品編號*], [*厚度(nm)*], [*接面寬度(μm)*], [*參考接面長度(μm)*], [*目標接面長度(μm)*], [*臨界電流(μA)*], [*回捕電流(μA)*], [*正常態電阻(Ω)*],  [*IcRn(μV)*], [*二極體效率(η)*], [*鈮鈦厚度(nm)*], [*備註*],
    [003-2], [],      [1.16], [0.40], [0.73], [19.1], [3],   [1.92],  [36.6],  [], [150], [],
    [003-3], [],      [0.88], [0.33], [0.65], [14.5], [1.5], [3.24],  [46.9],  [], [150], [],
    [004-1], [],      [1.26], [0.26], [0.68], [19.4], [16],  [11.17], [217.1], [], [70],  [Only Ref. JJ],
    [004-2], [],      [0.56], [0.17], [0.67], [32.5], [30],  [22.29], [725.1], [], [70],  [],
    [004-3], [],      [1.34], [0.24], [0.70], [44.5], [33],  [35.93], [1600.4],[], [70],  [],
    [005-1], [63.5],  [1.15], [0.42], [0.87], [88.4], [28],  [0.30],  [26.5],  [], [70],  [],
    [005-2], [24.2],  [1.57], [0.41], [0.88], [33.9], [6],   [1.07],  [36.2],  [], [70],  [],
    [019-1], [],      [2.59], [1.53], [2.26], [13.8], [1.5], [0.70],  [9.7],   [], [120], [],
    [019-3], [],      [1.73], [1.52], [2.36], [13.3], [0.8], [1.25],  [16.7],  [], [120], [],
    [019-5], [],      [3.42], [1.79], [6.09], [14.8], [6],   [0.26],  [3.9],   [], [120], [],
  ),
  caption: [樣品詳細資訊],
)
